"""
Django settings for safe_commit project.
...
SECRET_KEY = 'i5i^w-l1w7o%6%(2z-_a$t81asdxmlp3cx3lnk)pc93=5z#lrl'
...
WSGI_APPLICATION = 'safe_commit.wsgi.application'
...
DATABASES = {
    'default': {
        'NAME': configs.db_config('NAME'),
        'ENGINE': configs.db_config('ENGINE'),
